...
public class MillisToDateTimeFunction implements Function
{
	...
	public Object call(Context context, List args) throws FunctionCallException {
		...
		throw new FunctionCallException("millis-to-dateTime() requires exactly one argument.");
	}
	...
	public static String evaluate(Object obj, Navigator nav) throws FunctionCallException {
		...
		try {
			...
			throw new FunctionCallException("millis-to-dateTime() evaluation of '" + msecs + "' failed.", e);
		}
	}
